...
!
!svn $Id: fennel.h 937 2019-01-28 06:13:04Z arango $
!***********************************************************************
...
! (Added by Amin Ilia_ UCONN _2019) 
! Calculate gas flux due to bubbling at surface	wave breaking 
! Equations derived from McNeil and D’Asaro,2007; 
! Stanley et al., 2009; and Liang et al., 2013

! calculate surface drag coefficient cd	
            IF (SQRT(u10squ).le.11.0_r8) THEN
				cff4= 0.0012_r8
            ELSE IF (SQRT(u10squ).lt.20.0_r8                            & 
     &      	.AND. SQRT(u10squ).gt.11.0_r8) THEN
				cff4= (0.49_r8+0.0065_r8*SQRT(u10squ))*(1.0E-3_r8)
            ELSE IF (SQRT(u10squ).ge.20.0_r8) THEN
				cff4=0.0018_r8
            END IF
 
! Calculate Friction Velocity			
            cff5=SQRT(cff4*1.225_r8/1025_r8*u10squ)
			
! Calculate gas transfer rate through large bubbles 
            cff6=1.98E6_r8*cff5**(2.76_r8)                              &
     &      *(660.0_r8/SchmidtN_Ox)**(2.0_r8/3.0_r8)                    &
     &      *dtdays*24.0_r8/100.0_r8   !convert to m/s
			
! Calculate gas flux through small bubbles that completly desolved			
            cff7=21.0_r8/100.0_r8*5.56_r8*cff5**3.86_r8
